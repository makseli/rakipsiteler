...
/**
 * This is the model class for table "takip_grup".
 *
 * The followings are the available columns in table 'takip_grup':
 * @property integer $id
 ...
 */
class vtTakipGrup extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return vtTakipGrup the static model class
	 */
